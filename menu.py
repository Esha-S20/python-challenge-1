        ...
        if int(menu_category) in menu_items.keys():
            ...
            if menu_selection.isdigit():
                ...
                if menu_selection in menu_items.keys():
                    ...
                    print(f"You chose {item_name} which costs ${item_price:.2f} each.")
                    ...
                    print("Error. Menu selection is not an option in menu items.")
            else:
                print("Error. Menu selection is not a number.")
        else:
            # Tell the customer they didn't select a menu option
            print("Error. Menu catergory option was not a menu option.")
...
for item in order_list:
    ...
    print(f"{item_name}{item_name_spaces}|" + f" {price}{price_spaces} |" + f" {quantity}{quantity_spaces}")
